...
'''
    ...
    i=1 j=0 score[0] < score[0] True rank[1] = 2
        j=1 score[1] < score[1] False rank[1] = 2
        j=1 score[1] < score[1] rank[1] = 2
        j=2 score[1] < score[2] True rank[1] = 3
        j=4 score[1] < score[3] True rank[1] = 4
        j=5 score[1] < score[4] True rank[1] = 5   
        j=6 score[1] < score[5] True rank[1] = 6 (순위확정)      
    i=2 j=0 score[2] < score[0] True rank[2] = 2
        ...
        j=5 score[2] < score[5] True rank[2] = 3 (순위확정)    
'''
